...
model_paths=("NbAiLabBeta/nb-whisper-medium-verbatim")
...
for model_path in "${model_paths[@]}"; do
    # Loop over each split
        ...
        python test_dataset.py --device 1 --dataset_path NbAiLab/NPSC --name "16K_mp3_nynorsk" --split "test" --language "nn" --model_path "$model_path" --calculate_wer --save_file /home/perk/results.jsonl
done
