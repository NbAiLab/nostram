...
for model_path in "${model_paths[@]}"; do
    # Loop over each split
        ...
        python eval_model_wav2vec.py --extra_clean --text_field "transcription" --dataset_path Sprakbanken/nb_samtale --name "verbatim" --split "test" --model_path "$model_path" --calculate_wer --num_examples 500 --save_file /home/perk/results.jsonl
done
