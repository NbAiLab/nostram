...
valid_checkpoints = {
    "NbAiLab/nb-whisper-tiny-beta": 1,
    "NbAiLab/nb-whisper-base-beta": 1,
    "NbAiLab/nb-whisper-small-beta": 1,
    "NbAiLab/nb-whisper-medium-beta": 1,
    "NbAiLab/nb-whisper-large-beta": 1,
}
...
NUM_PROC = 32
FILE_LIMIT_MB = 1000
YT_LENGTH_LIMIT_S = 1*60*60  # limit to 1 hour YouTube files
...
article = f"Whisper JAX [code](https://github.com/sanchit-gandhi/whisper-jax) and Gradio demo by 🤗 Hugging Face."
